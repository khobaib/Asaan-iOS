...
@property (retain) NSNumber *deliveryDistance;  // longLongValue
...
@property (retain) NSNumber *priceRange;  // longLongValue
...
@property (retain) NSArray *trophies;  // of NSNumber (longLongValue)
