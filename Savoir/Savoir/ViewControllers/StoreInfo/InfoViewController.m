...
@property (weak, nonatomic) IBOutlet UITextView *web;
...
- (void)viewDidLoad {
    ...
    self.cellHeightArray = [[NSMutableArray alloc] initWithArray:@[@160, @300, @64, @400]];
//    
...
//        self.trophiesName.text = trophies;
        ...
        self.desc.text = _selectedStore.descriptionProperty ? _selectedStore.descriptionProperty : @"";
