 ...
 */
static NSString * const kConsumerKey       = @"rwakzicQGmkQml9LbVHWJw";
static NSString * const kConsumerSecret    = @"pDbzWTRCmXclUa91xJQQvfYv0C8";
static NSString * const kToken             = @"n6osqcky_nrodv-KJLXzDh6Xllm9Th_e";
static NSString * const kTokenSecret       = @"yaHq86z_DQXGgE0B5xo5CQvE8-c";
