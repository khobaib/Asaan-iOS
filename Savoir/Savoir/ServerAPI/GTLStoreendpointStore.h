...
@property (retain) NSNumber *providesDineInAndPay;  // boolValue
@property (retain) NSNumber *providesPosIntegration;  // boolValue
...
@property (retain) NSNumber *taxPercent;  // intValue
