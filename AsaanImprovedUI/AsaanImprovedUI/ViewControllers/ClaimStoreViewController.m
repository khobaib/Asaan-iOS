    ...
    [gtlStoreService executeQuery:query completionHandler:^(GTLServiceTicket *ticket, id object, NSError *error)
     {
         ...
         {
             NSString *str = @"Your employees have been saved. If this is your first time, Welcome! An Asaan representative will contact you shortly to verify your request and assist you with onboarding.";
